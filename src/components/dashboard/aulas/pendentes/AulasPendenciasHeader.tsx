...
export function AulasPendenciasHeader() {
  return (
      ...
      <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
        <div className="max-w-2xl">
          ...
          <p className="mt-2 text-sm leading-6 text-gray-500 dark:text-gray-400">
            Acompanhe aulas ainda não finalizadas e acesse rapidamente detalhes,
            conclusão ou exclusão de uma aula.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          ...
          <NavigationButton href="/dashboard/aulas/historico">
            Histórico
          </NavigationButton>
        </div>
      </div>
