...
export const createUserSchema = z.object({
  ...
  tel: z.string().min(11, "O telefone deve ter pelo menos 11 dígitos.").max(11, "O telefone deve ter no máximo 11 dígitos"),

  aluno: z.object({
      data_nasc: z.coerce.date(),
      serie: z.string(),
      escola: z.string().min(2, "A escola é obrigatória."),
      resp_tel: z.string().min(11, "O telefone do responsável deve ter pelo menos 11 dígitos.").max(11, "O telefone deve ter no máximo 11 dígitos"),
